...
<style>
    ...
    .custom-header-content .hero-bullets {
        margin-top: 10px;
    }
    .stChatMessage.user {
        ...
        box-shadow: 0 4px 18px rgba(16,163,127,0.10);
        margin-bottom: 10px;
        padding: 16px 18px;
        font-weight: 500;
        border: none;
    ...
    .stChatMessage.assistant {
        background: linear-gradient(90deg, #2A2B32 0%, #202123 100%);
        color: #ECECF1;
        border-radius: 16px 16px 16px 4px;
        box-shadow: 0 4px 18px rgba(16,163,127,0.08);
        margin-bottom: 10px;
        padding: 16px 18px;
        border: none;
    }
    ...
    .stButton > button:hover, div[data-testid="stFormSubmitButton"] button:hover {
        background: linear-gradient(90deg, #0D8C6B 0%, #10A37F 100%);
    ...
    .sidebar-panel, [data-testid="stSidebar"] {
        background: linear-gradient(180deg, #202123 0%, #23262e 100%);
        border-radius: 18px;
        border: 1.5px solid #10A37F22;
    ...
    .attachment-chip {
        ...
        margin-right: 6px;
        font-size: 0.92rem;
        border: 1.2px solid #10A37F44;
    }
    .composer-shell {
        background: linear-gradient(90deg, #23262e 0%, #202123 100%);
        border-radius: 18px;
        box-shadow: 0 2px 12px rgba(16,163,127,0.08);
    ...
    .footer-bar {
        width: 100%;
        background: linear-gradient(90deg, #202123 0%, #23262e 100%);
        color: #ECECF1;
        text-align: center;
        padding: 16px 0 8px 0;
        font-size: 0.98rem;
        border-top: 1.5px solid #10A37F22;
        position: relative;
        margin-top: 24px;
    }
    @media (max-width: 900px) {
        .custom-header { flex-direction: column; align-items: flex-start; padding: 18px 10px; }
        .custom-header-logo { margin-bottom: 10px; }
        .composer-shell { padding: 10px 6px; }
    }
...
<div class="custom-header">
    <div class="custom-header-logo">
        <img src="data:image/svg+xml;utf8,{open('assets/medibot_favicon.svg', 'r', encoding='utf-8').read().replace('"', '\"').replace('\n', '')}" alt="Medibot Logo" />
    </div>
    <div class="custom-header-content">
        <h1>Doctor Assistant</h1>
        <p>Your AI Medical Assistant for clinical Q&amp;A, live retrieval, and multimodal review.</p>
        <div class="hero-bullets">
            <span class="hero-chip">Grounded vector search</span>
            <span class="hero-chip">Voice, file, and image input</span>
            <span class="hero-chip">Fast model switching</span>
        </div>
    </div>
</div>
""",
...
<div class='footer-bar'>
    <p>Made with ❤️ using Streamlit, LangChain, and Groq | <b>Doctor Assistant v1.0</b></p>
    <div class='disclaimer-banner' style='margin: 12px auto 0 auto; max-width: 700px;'>
    ...
    <div style='margin: 10px 0 0 0; font-size: 0.92rem; color: #ECECF1;'><strong>Developed by Mayur Panchbhai</strong></div>
    <div style='font-size: 0.88rem; color: #10A37F; margin-top: 2px;'>
